...
</dom-module>`;document.head.appendChild($_documentContainer$4.content);Polymer$1({is:"paper-fab",behaviors:[PaperButtonBehavior],properties:{src:{type:String,value:""},icon:{type:String,value:""},mini:{type:Boolean,value:!1,reflectToAttribute:!0},label:{type:String,observer:"_labelChanged"}},_labelChanged:function(){this.setAttribute("aria-label",this.label)},_computeIsIconFab:function(icon,src){return 0<icon.length||0<src.length}});const PaperItemBehaviorImpl={hostAttributes:{role:"option",tabindex:"0"}},PaperItemBehavior=[IronButtonState,IronControlState,PaperItemBehaviorImpl];var paperItemBehavior={PaperItemBehaviorImpl:PaperItemBehaviorImpl,PaperItemBehavior:PaperItemBehavior};const $_documentContainer$5=document.createElement("template");$_documentContainer$5.setAttribute("style","display: none;");$_documentContainer$5.innerHTML=`<dom-module id="paper-item-shared-styles">
  <template>
    <style>
      :host, .paper-item {
        display: block;
...
</dom-module>`;document.head.appendChild($_documentContainer$5.content);Polymer$1({_template:html`
...
</dom-module>`;document.head.appendChild($_documentContainer$7.content);Polymer$1({is:"paper-spinner",behaviors:[PaperSpinnerBehavior]});const $_documentContainer$8=document.createElement("template");$_documentContainer$8.setAttribute("style","display: none;");$_documentContainer$8.innerHTML=`<dom-module id="paper-toggle-button">
  <template strip-whitespace="">
...
</dom-module>`;document.head.appendChild($_documentContainer$8.content);Polymer$1({is:"paper-toggle-button",behaviors:[PaperCheckedElementBehavior],hostAttributes:{role:"button","aria-pressed":"false",tabindex:0},properties:{},listeners:{track:"_ontrack"},attached:function(){afterNextRender(this,function(){setTouchAction(this,"pan-y")})},_ontrack:function(event){var track=event.detail;if("start"===track.state){this._trackStart(track)}else if("track"===track.state){this._trackMove(track)}else if("end"===track.state){this._trackEnd(track)}},_trackStart:function(){this._width=this.$.toggleBar.offsetWidth/2;this._trackChecked=this.checked;this.$.toggleButton.classList.add("dragging")},_trackMove:function(track){var dx=track.dx;this._x=Math.min(this._width,Math.max(0,this._trackChecked?this._width+dx:dx));this.translate3d(this._x+"px",0,0,this.$.toggleButton);this._userActivate(this._x>this._width/2)},_trackEnd:function(){this.$.toggleButton.classList.remove("dragging");this.transform("",this.$.toggleButton)},_createRipple:function(){this._rippleContainer=this.$.toggleButton;var ripple=PaperRippleBehavior._createRipple();ripple.id="ink";ripple.setAttribute("recenters","");ripple.classList.add("circle","toggle-ink");return ripple}});const resourceName="workorder";class AnyListView extends PolymerElement{constructor(){super()}static get properties(){return{workorders:{type:Array,reflectToAttribute:!0,notify:!0,value:[]},workordersLoaded:{type:Boolean,value:!1},workordersLoading:{type:Boolean,value:!1},isLoading:{type:Boolean,computed:"_isLoadingWorkorders(workordersLoaded, workordersLoading)"},isEmpty:{type:Boolean,computed:"_loadedAndNoRecords(isLoading)"},indexOptions:{type:Object,value:{index:{fields:["id","resourceName"]}}},fetchOptions:{type:Object,value:{selector:{resourceName:resourceName,id:{$gt:null}},fields:["_id","id","desc","status","assetNum","dueDate","timer"],sort:[{id:"asc"}],include_docs:!0,deleted:!1,limit:10,skip:0}},inputOn:{type:Boolean,value:!1},fieldsSearch:{type:Array,value:[{checked:!0,desc:"desc"},{checked:!0,desc:"status"},{checked:!1,desc:"assetNum"},{checked:!1,desc:"timer"},{checked:!1,desc:"id"}]},fieldsSortBy:{type:Array,value:[{checked:!1,desc:"desc"},{checked:!1,desc:"status"},{checked:!1,desc:"assetNum"},{checked:!1,desc:"timer"},{checked:!1,desc:"dueDate"},{checked:!0,desc:"id"}]},exactMatch:{type:Boolean,value:!1},sortAscending:{type:Boolean,value:!0,observer:"_sortDirectionChanged"}}}static get template(){return html$1`
      ${AnywhereStyles}
