...
<style>
...
</style>`;_exports.AnywhereStyles=AnywhereStyles;_exports.$anywhereStyles={AnywhereStyles:AnywhereStyles};class AnyQuickSearchBar extends PolymerElement{constructor(){super()}static get properties(){return{headerToggle:{type:String,value:"block",notify:!0},inputToggle:{type:String,value:"hidden",notify:!0},inputOn:{type:Boolean,value:!1}}}static get template(){return html`
      ${AnywhereStyles}
      <style>
        :host {
          flex: 1 auto;
    ...
    `}ready(){super.ready();this.$.listView.addEventListener("ready",()=>{this.$.quickSearchBar.addEventListener("searchTermChanged",this.$.listView.searchTermListener.bind(this.$.listView))})}_routePageChanged(page){if(!page){this.page="list-view"}if(-1!==["list-view","details-view","insp-list"].indexOf(page)){this.page=page}}_pageChanged(page){switch(page){case"list-view":new Promise((res,rej)=>_require.default(["./any-list-view.js"],res,rej)).then(bundle=>bundle&&bundle.$anyListView||{});this.pageTitle=this.$.listView.title;break;case"details-view":new Promise((res,rej)=>_require.default(["./any-details-view.js"],res,rej)).then(bundle=>bundle&&bundle.$anyDetailsView||{});this.pageTitle=this.$.detailsView.title;break;case"insp-list":new Promise((res,rej)=>_require.default(["./mx-inspector-list.js"],res,rej)).then(bundle=>bundle&&bundle.$mxInspectorList||{});this.pageTitle=this.$.inspList.title;break;}}}window.customElements.define("any-app",AnyApp)});